...
namespace RetroSim
{
    ...
    {
        this->showShaderParameters = showShaderParameters;
    ...
    void CoreImGui::DrawSystemPanel()
    {
        if (showSystem == false)
            return;
    ...
    void CoreImGui::DrawConfigPanel()
    {
        if (showConfig == false)
            return;
    ...
    void CoreImGui::DrawScriptPanel()
    {
    ...
    void CoreImGui::DrawMemoryPanel()
    {
    }

    void CoreImGui::DrawContextMenu()
    {
